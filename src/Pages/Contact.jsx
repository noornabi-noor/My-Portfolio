      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <p className="text-base sm:text-lg">+8801751321770 (Phone / WhatsApp)</p>
          </div>
          <div className="flex items-start gap-4">
        ...
        >
          ...
          <div>
            <label className="block mb-1 text-sm sm:text-base font-medium" htmlFor="name">
              Your Name
            </label>
            <input
              id="name"
          ...
          <div>
            <label className="block mb-1 text-sm sm:text-base font-medium" htmlFor="email">
              Your Email
            </label>
            <input
              id="email"
          ...
          <div>
            <label className="block mb-1 text-sm sm:text-base font-medium" htmlFor="message">
              Your Message
            </label>
            <textarea
              id="message"
          ...
          <button
            ...
            className="w-full py-2 sm:py-3 px-4 sm:px-6 bg-primary text-white text-sm sm:text-base rounded-md transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer hover:from-[#e0137b] hover:to-[#c40e6b] "
          >
            {state.submitting ? (
