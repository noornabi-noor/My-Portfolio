      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
        ...
        >
          ...
          <button
            ...
            className="w-full py-2 sm:py-3 px-4 sm:px-6 bg-primary text-white text-sm sm:text-base rounded-md hover:bg-primary-dark transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {state.submitting ? (
