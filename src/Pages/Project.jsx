...
const Projects = () => {
  ...
  return (
    <section id="projects" className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
      {/* Header */}
      ...
      <div className="space-y-8 sm:space-y-12">
        {projectData.map((project, index) => (
          <div key={index} className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-4 sm:p-6">
            {/* Project Image */}
