...
const About = () => {
  return (
    <section
      id="about"
      className="py-6 px-4 sm:py-8 sm:px-6 md:py-12 md:px-8 lg:px-16 rounded-lg md:rounded-2xl shadow-sm md:shadow-md lg:shadow-xl bg-white dark:bg-gray-900 mx-auto w-[95%] max-w-6xl"
    >
